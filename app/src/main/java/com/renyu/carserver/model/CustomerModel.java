...
public class CustomerModel implements Serializable {
    ...
    public void setCorporation_codeId(String corporation_codeId) {
        this.corporation_codeId = corporation_codeId;
    }
    ...
    public void setCorporation_codeId_photo(String corporation_codeId_photo) {
    ...
    public void setEparchy(String eparchy) {
    ...
    public void setRelated_shopid(int related_shopid) {
        this.related_shopid = related_shopid;
    }
    ...
    public void setAppove_status(String appove_status) {
        this.appove_status = appove_status;
    }

    public void setShop_photo_new(String shop_photo_new) {
        this.shop_photo_new = shop_photo_new;
    }
    ...
    public void setDoorway_addr(String doorway_addr) {
        this.doorway_addr = doorway_addr;
    }
